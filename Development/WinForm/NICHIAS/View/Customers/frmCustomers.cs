...
namespace NICHIAS.View.Customers
{
    public partial class frmCustomers : XtraForm
    {
        ...
        private void Search()
        {
            ...
            dgvDuLieu.DataSource = _customerRepository.GetAll().OrderBy(_ => _.CustomerName);
            Control();
        }
        ...
        {
            frmCustomersAddEdit frm = new frmCustomersAddEdit();
            frm.ShowDialog();
            Search();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                frmCustomersAddEdit frm = new frmCustomersAddEdit(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                _customerRepository.Remove(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
