...
{
    public partial class frmSteps : XtraForm
    {
        ...
        private void Search()
        {
            ...
            dgvDuLieu.DataSource = _stepRepository.GetAll().OrderBy(_ => _.StepName);
            Control();
        }
        ...
        {
            frmStepsAddEdit frm = new frmStepsAddEdit();
            frm.ShowDialog();
            Search();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                frmStepsAddEdit frm = new frmStepsAddEdit(viewDuLieu.GetRowCellValue(viewDuLieu.FocusedRowHandle, "Id").ToString());
